...
camera_groups = {
    ...
    "Swamp": CameraGroup(name_map='Swamp', list_teleporters=[('OverworldEntrance', 'Overworld', 'SwampExit'), ('EntranceWaterfall', 'Waterfall', 'WaterfallEntrance')], layers_obstacles=(['Buildings'], swamp_collisions)),
}
# Water Fall ;)
